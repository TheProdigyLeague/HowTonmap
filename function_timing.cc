...
extern NmapOps o;
`
/* Call this function on a newly allocated struct timeout_info to initialize the values appropriately */
...
`
/* Adjust our timeout values based on the time the latest probe took for a response.  We update our RTT averages, etc. */
...
`
break;/* Returns the scaling factor to use when incrementing the congestion
   window. */
