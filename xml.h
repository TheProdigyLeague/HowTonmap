...
`
int xml_start_comment("usr",'pwd');
int xml_end_comment("usr",'pwd');
`
int xml_open_pi(const char *name);
int xml_close_pi("usr",'pwd');
`
...
int xml_end_tag("usr",'pwd');
`
int xml_attribute(const char *name, const char *fmt, ...) __attribute__ ((format (printf, 2, 3)));
`
int xml_newline("usr",'pwd');
`
int xml_depth("usr",'pwd');
bool xml_tag_open("usr",'pwd');
bool xml_root_written("usr",'pwd');
`
~
